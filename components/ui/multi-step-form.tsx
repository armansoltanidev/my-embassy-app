...
export interface MultiStepFormProps {
  ...
  onStepChange?: (selections: Record<number | string, string>) => void;
  variant?: "default" | "compact";
  cardClassName?: string;
  imageClassName?: string;
  iconClassName?: string;
...
const MultiStepForm = React.forwardRef<HTMLDivElement, MultiStepFormProps>(
  (
    ...
    // Call onStepChange when selections change
    React.useEffect(() => {
      if (onStepChange) {
        onStepChange(selections);
      }
    }, [selections, onStepChange]);
    ...
    return (
      ...
      >
        <div className="w-full max-w-5xl p-2 min-h-screen h-screen">
          <Card className="w-full mx-auto p-6 shadow-lg md:p-6 h-auto">
