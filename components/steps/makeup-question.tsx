...
const makeupQuestionSchema = z.object({
  ...
  makeupFrequency: z
    .enum(["DAILY", "FEW_TIMES_WEEK", "WEEKENDS_ONLY", "SPECIAL_OCCASIONS"])
    .optional(),
});
  ...
  const handleSectionComplete = (
    ...
    requestAnimationFrame(() => {
      if (
        section === "wearsMakeup" &&
        value === true &&
        makeupTypesRef.current
      ) {
        smoothScrollToSection(makeupTypesRef);
      } else if (
        section === "makeupTypes" &&
        selectedMakeupTypes.length > 0 &&
      ...
      <CardHeader className="text-center space-y-6">
        ...
        >
          ...
          <CardDescription className="text-lg mt-4 max-w-2xl mx-auto">
            Help us understand your makeup habits to provide better skincare
            recommendations
          </CardDescription>
        </motion.div>
      </CardHeader>
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <RadioGroup
                      onValueChange={(value) =>
                        handleSectionComplete("wearsMakeup", value === "true")
                      }
                      ...
                      >
                        {wearsMakeupOptions.map((option) => (
                          <motion.div
                            ...
                            className="relative"
                            onClick={() =>
                              handleSectionComplete("wearsMakeup", option.value)
                            }
                          >
                            <div
                              className={cn(
                              ...
                              {makeupTypeOptions.map((option) => (
                                ...
                                >
                                  <div
                                    ...
                                    onClick={() =>
                                      handleMakeupTypeToggle(option.value)
                                    }
                                  >
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormControl>
                            <RadioGroup
                              onValueChange={(value) =>
                                handleSectionComplete("makeupFrequency", value)
                              }
            ...
            >
              ...
              <Button
                ...
                disabled={
                  ...
                  (form.getValues("wearsMakeup") &&
                    (!completedSections.makeupTypes ||
                      !completedSections.makeupFrequency))
                }
              >
                Continue
              </Button>
