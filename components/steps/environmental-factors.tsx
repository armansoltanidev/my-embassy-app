...
const environmentalOptions = [
  {
    value: "ARID",
    label: "Arid Climate",
    description: "Dry, low humidity environment",
    icon: Sun,
    imageUrl:
      "https://www.thenatureofcities.com/TNOC/wp-content/uploads/2019/01/Wadi-Hanifa-restoration2.jpg",
  ...
  },
  {
    ...
    icon: Cloud,
    imageUrl:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDFis2XLc3CSgavIJpGObaDKuh5-LAror08Q&s",
  ...
  },
  {
    ...
    icon: Building2,
    imageUrl:
      "https://toposmagazine.com/wp-content/uploads/2023/05/Zhengzhou_Greenland_Central_Plaza_in_fog-scaled.jpg",
