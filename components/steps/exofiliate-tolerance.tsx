...
const exfoliationSchema = z.discriminatedUnion("exfoliationFrequency", [
  ...
  z.object({
    ...
    exfoliationType: z
      .enum(["PHYSICAL_SCRUBS", "CHEMICAL_EXFOLIANTS", "ENZYME_EXFOLIATORS"], {
          ...
          <form onSubmit={form.handleSubmit(handleNext)} className="space-y-8">
            ...
            <div className="flex items-center gap-2 text-primary bg-primary/5 p-4 rounded-lg">
              ...
              <p className="text-sm font-medium">
                Help us understand your exfoliation tolerance better
              </p>
            </div>
            {/* Exfoliation Type Section */}
            {(form.getValues("exfoliationFrequency") === "WEEKLY" ||
              form.getValues("exfoliationFrequency") ===
                "TWO_TO_THREE_TIMES_WEEK") && (
              <div
                ref={typeRef}
            ...
            <div className="flex justify-between pt-6">
              ...
              <Button
                ...
                disabled={
                  ...
                  (form.getValues("exfoliationFrequency") !== "NEVER" &&
                    !completedSections.exfoliationType)
                }
              >
                <span>Continue</span>
              </Button>
