  ...
  const ageGroupOptions = [
    {
      ...
      keyIngredients: ["Salicylic Acid", "Hyaluronic Acid"],
      bgColor: "bg-blue-50",
      imageUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRr_Fwe5vK_l0HlV4znGl-GuSlb79I2eVnDBQ&s",
    },
    {
      value: "TWENTIES",
      label: "20s",
      ...
      keyIngredients: ["Hyaluronic Acid", "Vitamin C", "Glycolic Acid"],
      bgColor: "bg-pink-50",
      imageUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTF2qLT7T2vRqbGGabVph55yb-jKtklhSS8ng&s",
    },
    {
      value: "THIRTIES",
      label: "30s",
      ...
      imageUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPoMBa9NlASWugpVnGf9YYJJuEpcgezZXMJg&s",
    },
    {
      value: "FORTIES",
      label: "40s",
      ...
      keyIngredients: ["Peptides", "Retinol", "Hyaluronic Acid"],
      bgColor: "bg-orange-50",
      imageUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSoL8X8Cy7-S_fuy5GKdasasj-DJzi5uFEy6A&s",
    },
    {
      value: "FIFTIES",
      label: "50s",
      ...
      keyIngredients: ["Peptides", "Niacinamide"],
      bgColor: "bg-green-50",
      imageUrl:
        "https://img.freepik.com/premium-photo/happy-asian-woman-50s-pampering-skin-spa-ad_1168123-85572.jpg",
    },
    {
      value: "SIXTIES_PLUS",
      label: "60s and above",
      ...
      keyIngredients: ["Vitamin B5", "Niacinamide", "Squalane"],
      bgColor: "bg-yellow-50",
      imageUrl:
        "https://www.currentbody.com.au/cdn/shop/articles/Best_skincare_devices_for_your_60_s_and_70_s.png?v=1712056320",
    },
  ];
    ...
    <Card className="border-none shadow-none">
      <CardHeader>
        ...
        >
          ...
          <CardDescription>
            Help us customize your perfect skincare routine based on your age
            group
          </CardDescription>
        </motion.div>
      </CardHeader>
