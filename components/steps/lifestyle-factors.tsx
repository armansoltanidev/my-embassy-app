...
const LifestyleFactors = ({ step }: { step: number }) => {
        ...
        >
          <Card
            className={cn(
              ...
              form.getValues(
                fieldName as "stressLevels" | "sleepPatterns" | "sunExposure"
              ) === option.value
  ...
  return (
    <Card className="border-none shadow-none">
      <CardHeader>
        <CardTitle className="text-4xl font-serif mb-4 text-left md:text-center">
          Your Lifestyle Factors
        </CardTitle>
        <CardDescription>
          Help us understand your daily lifestyle to personalize your skincare
          routine.
        </CardDescription>
      </CardHeader>
