...
const ClimateBackground = ({
  ...
  useEffect(() => {
    const particleCount =
      climateType === "ARID" ? 100 : climateType === "HUMID" ? 80 : 60;
  ...
  const renderAridBackground = () => (
    <g>
      ...
      {/* Rolling Hills */}
      <path
        d="M0 70 Q15 50 30 70 T60 70 Q75 55 90 70 L100 70 L100 100 L0 100 Z"
        fill="#EAB308"
        opacity="0.4"
      />
      <path
        d="M0 80 Q20 60 40 80 T80 80 Q90 65 100 80 L100 100 L0 100 Z"
        fill="#D97706"
        opacity="0.6"
      />
      <path
        d="M0 85 Q25 70 50 85 T100 85 L100 100 L0 100 Z"
        fill="#B45309"
        opacity="0.8"
      />
      ...
      {particles.map((particle) => (
        <motion.path
          ...
          d={`M${particle.x} ${particle.y} q${
            10 + particle.size
          } ${-particle.size} ${20 + particle.size * 2} ${-particle.size}`}
          stroke="#FDE68A"
