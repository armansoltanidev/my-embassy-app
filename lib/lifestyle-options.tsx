...
const FlameSVG = () => (
  ...
  >
    <motion.path
      fill="currentColor"
      initial={{
        d: "M50 90 Q30 70, 40 50 Q35 30, 50 10 Q65 30, 60 50 Q70 70, 50 90 Z",
      }}
      animate={{
        d: [
...
const lifestyleFactors = {
  sunExposure: {
    ...
    description:
      "Understanding your sun exposure helps us recommend appropriate UV protection",
    containerClass:
      "bg-gradient-to-b from-amber-50/50 to-transparent p-6 rounded-lg border border-amber-100",
    iconClass: "text-amber-500",
  },
  stressLevels: {
    title: "Stress Management",
    description:
      "Stress can significantly impact your skin's health and appearance",
    containerClass:
      "bg-gradient-to-b from-rose-50/50 to-transparent p-6 rounded-lg border border-rose-100",
  ...
  sleepPatterns: {
    ...
    containerClass:
      "bg-gradient-to-b from-sky-50/50 to-transparent p-6 rounded-lg border border-sky-100",
...
const exfoliationFrequencyOptions = [
  {
    ...
    icon: Circle,
    details:
      "Best for extremely sensitive skin or those new to skincare routines",
  },
  {
    value: "WEEKLY",
    label: "Weekly",
    ...
    icon: Circle,
    details:
      "Ideal for sensitive or normal skin types seeking balanced maintenance",
  },
  {
    ...
    icon: Circle,
    details:
      "Perfect for oily or combination skin types requiring frequent cell turnover",
  },
];
...
const exfoliationTypeOptions = [
  {
    ...
    icon: Brush,
    details:
      "Best for: Oily skin, thick skin texture. Use with gentle pressure in circular motions.",
  ...
  },
  {
    ...
    icon: FlaskConical,
    details:
      "Best for: Aging concerns, hyperpigmentation. Start with lower concentrations.",
  ...
  },
  {
    ...
    icon: Apple,
    details:
      "Best for: Sensitive skin, rosacea-prone. Natural option derived from fruits.",
...
const makeupSection = {
  wearsMakeup: {
    title: "Makeup Usage",
    description:
      "Tell us about your makeup habits to better understand your skincare needs",
    containerClass:
      "bg-gradient-to-b from-pink-50/50 to-transparent p-6 rounded-lg border border-pink-100",
  ...
  makeupTypes: {
    ...
    containerClass:
      "bg-gradient-to-b from-purple-50/50 to-transparent p-6 rounded-lg border border-purple-100",
  ...
  frequency: {
    ...
    containerClass:
      "bg-gradient-to-b from-violet-50/50 to-transparent p-6 rounded-lg border border-violet-100",
...
const residentTypeOptions = [
  {
    value: "PASSPORT",
    label: "پاسپورت اقامتی",
    description: "پاسپورت اقامتی دارای روادید تمدید شده معتبر",
    icon: "📓",
    illustration: (
  ...
  },
  {
    value: "AMAYESH_CARD",
    label: "کارت آمایش",
    description: "کارت آمایش دارای تاریخ معتبر",
    icon: "🪪",
    illustration: (
      <div className="w-16 h-16 mb-4 bg-primary/10 rounded-full flex items-center justify-center">
        <span className="text-2xl">🪪</span>
  ...
  },
  {
    value: "RESIDENT_BOOK",
    label: "دفترچه اقامت",
    description: "دفترچه اقامت مورد تایید وزارت کشور",
    icon: "📗",
    illustration: (
      <div className="w-16 h-16 mb-4 bg-primary/10 rounded-full flex items-center justify-center">
        <span className="text-2xl">📗</span>
  ...
  {
    value: "FAMILIY_PASSPORT",
    label: "پاسپورت خانواری",
    description: "پاسپورت خانواری دارای روادید تمدید شده معتبر",
    icon: "📓",
    illustration: (
      <div className="w-16 h-16 mb-4 bg-primary/10 rounded-full flex items-center justify-center">
        <span className="text-2xl">📓</span>
...
export {
  ...
  residentTypeOptions as skinGoalOptions,
};
